...
| Service Role Key (后端用) | `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...REDACTED-ROTATE` |
...
$env:SUPABASE_SERVICE_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...REDACTED-ROTATE"
